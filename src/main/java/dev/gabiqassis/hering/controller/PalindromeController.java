...
import static dev.gabiqassis.hering.common.constants.PathConstants.PALINDROME_V1;
...
public interface PalindromeController {
    ...
    @GetMapping(PALINDROME_V1)
    ResponseEntity<PalindromeResponse> isPalindrome(@RequestParam String word);
}
